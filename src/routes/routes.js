...
const { createUser, userLogin, userLogout, getUserData, rejectRequest, searchFiends, getFriendsProfile,
    acceptRequest, viewProfile, forgotPasswordOtp, sendRequest, updateUser, deleteFriend, updatePassword, checkOtp } = require("../controllers/userController")
...
router.get("/api/viewprofile", authentication, viewProfile)
